...
const COMPONENT_LIBRARY: ComponentDefinition[] = [
  ...
  },
  {
    ...
    pins: [
      ...
      { index: 2, name: 'CAP 2', type: 'bidirectional' },
      { index: 3, name: '2P OUT', type: 'output' },
      { index: 4, name: 'N/C', type: 'bidirectional' },
      { index: 5, name: 'CAP 3', type: 'bidirectional' },
      { index: 6, name: 'CAP 4', type: 'bidirectional' },
      { index: 7, name: 'OUTPUT', type: 'output' },
      { index: 8, name: 'V+', type: 'power' },
      { index: 9, name: 'GND', type: 'ground' },
      { index: 10, name: 'V-', type: 'power' },
      ...
      { index: 15, name: 'N/C', type: 'bidirectional' },
      { index: 16, name: 'N/C', type: 'bidirectional' },
      { index: 17, name: 'FREQ CV', type: 'cv' },
    ],
    defaultParameters: { cap1: 10e-9, cap2: 3.3e-9, cap3: 10e-9, cap4: 2.2e-9, resonance: 0 },
  },
  {
    type: 'SSI2144',
    name: 'SSI2144 VCF',
    category: 'vcf',
    package: 'DIP16',
    description: 'Sound Semiconductor modern reissue. Uniform 4-pole LP. SSM2044 successor.',
    pins: [
  ...
  },
  {
    ...
    pins: [
      ...
      { index: 2, name: 'EC', type: 'cv' },
      { index: 3, name: 'V+', type: 'power' },
      { index: 4, name: 'V-', type: 'power' },
      { index: 5, name: 'SYM GND', type: 'ground' },
      { index: 6, name: 'SIG OUT', type: 'output' },
      { index: 7, name: 'BYPASS', type: 'bidirectional' },
    ],
    defaultParameters: { distortion: 0.003 },
  },
  {
    type: 'THAT2180',
    name: 'THAT 2180 VCA',
    category: 'vca',
    package: 'DIP8',
    description: 'Modern Blackmer-cell VCA. Cleaner successor to dbx 2150. 6mV/dB.',
    pins: [
      { index: 0, name: 'SIG IN+', type: 'input' },
      { index: 1, name: 'SIG IN-', type: 'input' },
      { index: 2, name: 'EC', type: 'cv' },
    ...
    defaultParameters: { distortion: 0.0005 },
  },
  {
    type: 'SSM2164',
  ...
  },
  {
    ...
    category: 'dac',
    package: 'DIP14',
    description: 'Dual 12-bit SPI DAC. Pi GPIO interface for waveform/CV output.',
    pins: [
      { index: 0, name: 'VDD', type: 'power' },
      { index: 1, name: 'N/C', type: 'bidirectional' },
      { index: 2, name: 'CS', type: 'input' },
      { index: 3, name: 'SCK', type: 'input' },
      { index: 4, name: 'SDI', type: 'input' },
      { index: 5, name: 'N/C', type: 'bidirectional' },
      { index: 6, name: 'VOUT A', type: 'output' },
      { index: 7, name: 'VSS', type: 'ground' },
      { index: 8, name: 'LDAC', type: 'input' },
      { index: 9, name: 'SHDN B', type: 'input' },
      { index: 10, name: 'SHDN A', type: 'input' },
      { index: 11, name: 'VOUT B', type: 'output' },
      { index: 12, name: 'VREF B', type: 'input' },
      { index: 13, name: 'VREF A', type: 'input' },
    ],
    defaultParameters: { vref: 3.3, value_a: 2048, value_b: 2048, freq: 440 },
  },
  {
    type: 'LF347',
    ...
    pins: [
      ...
      { index: 7, name: 'OUT C', type: 'output' },
      { index: 8, name: 'IN C-', type: 'input' },
      { index: 9, name: 'IN C+', type: 'input' },
      { index: 10, name: 'V-', type: 'power' },
      { index: 11, name: 'IN D+', type: 'input' },
      { index: 12, name: 'IN D-', type: 'input' },
      { index: 13, name: 'OUT D', type: 'output' },
    ],
    defaultParameters: { supply: 15 },
  },
  {
    type: 'TL072',
